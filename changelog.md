...
- Updated defaults for `_config.dev.yml` and `_config.prod.yml`
- Added `wrangler.toml` template for Cloudflare Pages deploys
- Fixed missing permissions in GitHub Actions config
